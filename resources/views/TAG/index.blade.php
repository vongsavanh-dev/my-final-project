        ...
        <div class="card-header">
            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <a href="{{route('tag.create')}}"><i class='fas fa-edit' style='font-size:36px'></i>ເພີ່ມຂໍ້ມູນ</a>
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="100%">
                    <thead>
                        <tr>
                            ...
                            <th scope="col">ຊື່ Tag</th>
                            <th scope="col">ຈຳນວນແຈ້ງການທີ່ໃຊ້</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{route('tag.edit',$tag->id)}}"><i class='fas fa-tools'
                                        style='font-size:30px;color:rgb(17, 0, 255);'></i>ແກ້ໄຂ</a></a>
                            </td>
                            <td>
                                <form class="delete-confirm" action="{{route('tag.destroy',$tag->id)}}" method="POST">
                                    @csrf
