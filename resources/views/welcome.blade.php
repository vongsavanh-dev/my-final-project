                ...
                <div class="main_home_slider text-center">
                    ...
                    <div class="single_home_slider">
                        ...
                        <div class="main_home wow fadeInUp" data-wow-duration="700ms">
                            ...
                            <h2 style="font-weight: bold;color:#ffff;">ວິທະຍາໄລລາວວຽງ</h2>
                            <div class="separator" style="background:#ffff; width:200px;height:6px;"></div>
                            <p class="subtitle" style="color:#ffff;">LaoVieng Collage <br />
                                Laovieng Collage Registration</p>
                            <div class="home_btn">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 col-sm-push-6">
                                <div class="signle_service_left">
                                    <img src="fontend/images/laovieng1.jpg" alt="" />
                                </div>
                            </div>

                            <div class="col-sm-5 col-sm-pull-6">
                                <div class="single_service">
                                    <h4>History of Laovieng</h4>
                                    <div class="separator2"></div>
                                    <h3>ປະຫວັດຂອງວິທະຍາໄລລາວວຽງ</h3>
                    ...
                    <div class="single_team">
                        <div class="col-sm-10 col-sm-offset-1">
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <div class="team">
                                        <img class="img-circle" src="fontend/images/team3.jpg" alt="" />
                                        <h4>diane lewis</h4>
                                        <div class="separator"></div>
                                        <p>artist, designer</p>
                                    </div>
                            ...
                            <div class="col-sm-6 col-xs-12">
                                <div class="single_message_right_info whitetext">
                                    <ul>
                                        ...
                                        <li><i class="fa fa-mobile-phone"></i> <span>02097970818</span></li>

                                        <li><i class="fa fa-envelope-o"></i> <span>Laovieng@gmail.com</span>
                                        </li>
                                    </ul>
