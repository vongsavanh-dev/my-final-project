...
class UpdateStudentRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'father_job.required' => 'ປ້ອນອາຊີບພໍ່',
            'mother_job.required' => 'ປ້ອນອາຊີບແມ່',
            'family_village.required' => 'ປ້ອນບ້ານຢູ່',
            'family_city.required' => 'ປ້ອນເມືອງ',
            'family_province.required' => 'ປ້ອນແຂວງ',
